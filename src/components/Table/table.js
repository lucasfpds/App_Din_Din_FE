  ...
  return (
    <div className="table">
      <div className="table-head">
        <ul>
          <li
            onClick={() => handleOrderDocuments("date")}
            className="column-title column-date date"
            id="date"
          >
            Data <img src={polygonDate} alt="Ordenar por Data" />
          </li>
          <li
            onClick={() => handleOrderDocuments("day")}
            className="column-week-day weekDay"
            id="week-day"
          >
            Dia da Semana{" "}
            <img src={polygonWeekDay} alt="Ordenar por Dia da Semana" />
          </li>
          <li className="column-description">Descrição</li>
          <li className="column-category">Categoria</li>
          <li
            onClick={() => handleOrderDocuments("value")}
            className="column-value value"
            id="value"
          >
            Valor <img src={polygonValue} alt="Ordenar por Valor" />
          </li>
          <li></li>
        </ul>
      </div>
      ...
      <div className="table-body">
        {documents.map((element, index) => {
          return (
            <TableBody
              handleShowItemDelete={handleShowItemDelete}
              itemHidden={hidden}
              index={index}
              handleRegisterDocument={handleRegisterDocument}
              openModal={openModal}
              document={element}
            />
          );
